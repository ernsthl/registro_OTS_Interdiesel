...
with st.form("form_registro", clear_on_submit=True):
    ...
    with col2:
        ...
        tecnico = st.multiselect("👨‍🔧 Técnicos asignados", ["Armando", "Alexander", "Dario", "Externo", "Gisell", "Ronal", "Santiago"], default=[])
    ...
    with st.form("form_actualizar"):
        ...
        with col1:
            ...
            tecnico = st.multiselect(
                "👨‍🔧 Técnicos asignados",
                ["Armando", "Alexander", "Dario","Externo","Gisell", "Santiago", "Ronal"],
